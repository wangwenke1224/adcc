...
/* MongoDB conf on local */

// $config['default']['mongo_hostbase'] = 'localhost:27017';
// $config['default']['mongo_database'] = 'codeigniter';
// $config['default']['mongo_username'] = '';
// $config['default']['mongo_password'] = '';

/* MongoDB conf on MongoHQ */
$config['default']['mongo_hostbase'] = 'alex.mongohq.com:10099';
$config['default']['mongo_database'] = 'adcc';
$config['default']['mongo_username'] = 'si664adcc';
$config['default']['mongo_password'] = 'si664project';
